# -*- coding: utf-8 -*-
"""
Created on Fri May  5 13:18:13 2017

@author: NOT Sergio
the code below is an implementation to calculate sunrise and sunset in Python 3.x, as
found in http://michelanders.blogspot.nl/2010/12/calulating-sunrise-and-sunset-in-python.html

This implementation was not developed by me and all credits (and complaints!) go to the original author. 
"""
