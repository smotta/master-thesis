...
def outcome(situation, i, j, inverters, batlist, apartment = "void"):
    ...
    if mode == "inv":
        if situation == 0:
            ...
            #inverters[i].apartments[selected].batcharge[j] = inverters[i].apartments[selected].batcharge[j] * batlist[i].efficiency
            ...
            batenergy = min((batlist[i].chargeStatus[j-1] - batlist[i].depthDisch), inverters[i].apartments[selected].consumption[j])       #this is the energy being sent
    ...
    #PLACING THE BATTERIES IN EACH APARTMENT
        ...
        if situation == 0:
            ...
            batlist[i][selected].batlosses[j] = batenergy - batenergy*batlist[i][selected].efficiency
            batenergy = batenergy * batlist[i][selected].efficiency
            ...
            #battery is being affected as
            batlist[i][selected].chargeStatus[j] = batlist[i][selected].chargeStatus[j-1] - batenergy/batlist[i][selected].efficiency
            ...
            #considering the losses
            batlist[i][selected].batlosses[j] = inverters[i].apartments[selected].batcharge[j] - inverters[i].apartments[selected].batcharge[j]*batlist[i][selected].efficiency
            
            #the apartment sends energy to the grid as the generation - used energy - energy that goes to the battery
            inverters[i].apartments[selected].gridfeedin[j] = (inverters[i].receivedgen[j] - inverters[i].apartments[selected].energyreceived[j] - 
                                                                 inverters[i].apartments[selected].batcharge[j])
            #battery being affected as
            batlist[i][selected].chargeStatus[j] = batlist[i][selected].chargeStatus[j-1] + inverters[i].apartments[selected].batcharge[j]*batlist[i][selected].efficiency
        ...
        #SELECTED is irrelevant for the following outcomes - they will happen for all apartments
            ...
            #considering the losses
            batlist[i][apartment].batlosses[j] = batenergy - batenergy*batlist[i][apartment].efficiency
            batenergy = batenergy * batlist[i][apartment].efficiency
            ...
            #battery being affected as
            batlist[i][apartment].chargeStatus[j] = batlist[i][apartment].chargeStatus[j-1] - batenergy/batlist[i][apartment].efficiency
